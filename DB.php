...
class DB
{
	...
	/* var $server="lin22.yoncu.com";
	var $username="avatarme_avatarmedya";
	var $password="Serkan6327.";
	var $dbname="avatarme_avatarmedya";
	var $connection; */

	var $server="localhost";
	var $username="root";
	var $password="";
	var $dbname="adminpanel_avatar";
	var $connection;
	...
	public function aylikUlasilanMusteriSayisi()
	{
		...
		$totalumusteri = $totalumusteri + count($aylikumusteri);


		return number_format($totalumusteri);
	}
	...
	public function yillikUlasilanMusteriSayisi()
	{
		...
		$totalymusteri = $totalymusteri + count($aylikymusteri);
	...
	public function teslimedilenSiparisYuzdelikArtis()
	{
		...
		$eski = count($ayliksatissiparisyuzdelikartis);
		$yeni = count($simdisiparisyuzdelikartis);
